...
file_name <- paste("/Users/yanwang/Desktop/LinkedinData/IndustryAnlysis/treetraining", "_160.Rda", sep="")
load(file_name)
...
file_name <- "/Users/yanwang/Desktop/LinkedinData/IndustryAnlysis/supportvectormachine.Rda"
