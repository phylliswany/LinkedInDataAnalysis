...
In order to create a balanced data set with an equal number of people in each industry, the code in "" 2000 profiles are randomly selected in each industry 